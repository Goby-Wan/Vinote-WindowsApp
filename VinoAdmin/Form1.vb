...
Public Class Form1
    ...
    Public Sub chargement()
        ...
        url = "http://192.168.2.130/vinote/web/app_dev.php/exposants"
        ...
        Dim objVin As Vin()
        url = "http://192.168.2.130/vinote/web/app_dev.php/vins"
        content = synClient.DownloadString(url)
        ...
        url = "http://192.168.2.130/vinote/web/app_dev.php/invites"
        content = synClient.DownloadString(url)
        ...
        Dim obj As Note()
        url = "http://192.168.2.130/vinote/web/app_dev.php/notes"
        content = synClient.DownloadString(url)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If DataGridView1 IsNot Nothing Then
            ...
            Dim uri As New Uri("http://192.168.2.130/vinote/web/app_dev.php/" & selectedCombobox & "/" & id)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If (DialogResult = MessageBoxButtons.OK) Then
            ...
            Dim content = "{""id"":" & id & "}"
            Dim uri As New Uri("http://192.168.2.130/vinote/web/app_dev.php/" & ComboBox1.SelectedItem & "s" & "/" & id)
            Dim data = Encoding.UTF8.GetBytes(content)
            Console.WriteLine(content)
            Console.WriteLine(uri)
            'If (SendRequest(uri, data, "application/json", "DELETE") = "") Then
            'btCharge_Click(sender, e)
            '  End If
